...
{
    public partial class TeacherReport : UserControl
    {
        ...
        public void GetClassData()
        {
            if (string.IsNullOrEmpty(ClassId))
            {
               ...
               SelectTableFromClassPage(Configs.FilterTeacherClasses, parameters);
            }
            else
            {
        ...
        private void StudentcomboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            GetStudentData();
                ...
                SelectTableFromStudentPage(Configs.FilterTeacherClasses, parameters);
                    }
                    else
                    {
                ...
                SelectTableFromStudentPage(Configs.FilterTeacherStudent, parameters);
                    }
                }
